...
const SearchFlightResult = ({flight}) => {
    ...
    //                     <div className={`col-3`}>
    //                         <p>
    //                             <strong>{moment(flight?.flightSchedule?.departureTime, 'HH:mm:ss').format("h:mm A")}</strong>
    //                             <br/>
    ...
    //                     <div className={`col-3`}>
    //                         <p>
    //                             <strong>{moment(flight?.flightSchedule?.arrivalTime, 'HH:mm:ss').format("h:mm A")}</strong>
    //                             <br/>
